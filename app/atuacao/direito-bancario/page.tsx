...
export default function DireitoBancario() {
  ...
  return (
    <main id="main-content" className="min-h-[100dvh] lg:h-screen bg-slate-950 flex flex-col justify-center relative overflow-hidden px-5 py-6 lg:px-12 lg:py-8">
      ...
      {/* Container Principal */}
      <div className="mx-auto grid lg:grid-cols-2 lg:items-center gap-6 lg:gap-14 w-full max-w-6xl relative z-10 my-auto">
        ...
        <div className="flex flex-col justify-center">
          ...
          {/* 1. TEXTO PRINCIPAL */}
          <h1 className="mb-3 font-serif text-[clamp(1.75rem,7vw,3.2rem)] font-semibold leading-[1.15] tracking-[-0.02em] text-white [text-wrap:balance] opacity-0 animate-[fadeIn_600ms_cubic-bezier(0.16,1,0.3,1)_200ms_forwards]">
            Proteção patrimonial<br />contra abusos<br />financeiros
          </h1>
          
          <p className="mb-5 max-w-[48ch] text-[13px] sm:text-sm leading-relaxed text-slate-300 lg:text-base opacity-0 animate-[fadeIn_600ms_cubic-bezier(0.16,1,0.3,1)_300ms_forwards]">
          ...
          <div className="block lg:hidden my-4 mx-auto">
            <FotoAdvogada />
          </div>

          {/* 3. CALL TO ACTION */}
          <div className="opacity-0 animate-[fadeIn_600ms_cubic-bezier(0.16,1,0.3,1)_400ms_forwards]">
            <div className="mb-3 h-[1px] w-16 bg-[#C5A059]" />
            
            <h2 className="text-base sm:text-lg font-serif font-semibold text-white mb-1">
              Sua saúde financeira está ameaçada?
            </h2>
            
            <p className="mb-4 text-xs text-slate-300 max-w-[45ch] leading-relaxed">
